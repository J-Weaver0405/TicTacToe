...
let runBot = true; //this also a global variable with boolen value..used this variable to stop the bot once match won by someone or drawn
...
function clickedBox(element){
    ...
    element.style.pointerEvents = "none"; //once user select any box then that box can't be clicked again
